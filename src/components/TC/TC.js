    ...
    return (
      <ScrollView style={styles.mainContainer}>
        ...
        <View style={styles.bodyContainer}>
          ...
          <Text style={styles.segment}>
            Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the Mixdo mobile application (the "Service") operated by Mixdo Inc. ("us", "we", or "our").
          </Text>
          <Text style={styles.segment}>
          ...
          <Text style={styles.subHeader}>Communications</Text>
          <Text style={styles.segment}>
          ...
          <Text style={styles.segment}>
            Mixdo Inc. has the right but not the obligation to monitor and edit all Content provided by users.
          </Text>
          <Text style={styles.segment}>
            In addition, Content found on or through this Service are the property of Mixdo Inc. or used with permission. You may not distribute, modify, transmit, reuse, download, repost, copy, or use said Content, whether in whole or in part, for commercial purposes or for personal gain, without express advance written permission from us.
          </Text>
          ...
          <Text style={styles.segment}>
            The Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of Mixdo Inc. and its licensors. The Service is protected by copyright, trademark, and other laws of both the United States and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Mixdo Inc..
          </Text>
          ...
          <Text style={styles.segment}>
            Mixdo Inc. has no control over, and assumes no responsibility for the content, privacy policies, or practices of any third party web sites or services. We do not warrant the offerings of any of these entities/individuals or their websites.
          </Text>
          <Text style={styles.segment}>
